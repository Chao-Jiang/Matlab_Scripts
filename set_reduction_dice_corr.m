...
for cont=1:num_of_contrasts
    ...
    ref_thresh=niftiread([parentDir '/' myDirs{end} '/' myContrast_thresh]);
    ref_no_thresh=niftiread([parentDir '/' myDirs{end} '/' myContrast_no_thresh]);
